...
- 작업 후 해당 칼럼을 함수로 계산하여 정규화 및 점수화를 진행하였습니다.
  ...
  <img src="md-images/rel2-163612854392011.png" alt="rel2" style="zoom:75%;" />

- 총 매출 금액을 로그화 하여 범위를 좁히고 상점의 개수로 나누어 정규화 한 모습

![rel3](md-images/rel3-163612854392013.png)

- 정규화 된 자료를 구간별로 점수화 

![rel4](md-images/rel4-163612854392012.png)

- 점수별로 코멘트를 `if` 문을 통하여 구분하여 달아줌

  ![rel5](md-images/rel5-163612854392014.png)
